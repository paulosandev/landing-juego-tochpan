...
export class SpriteRenderer {
     ...
     */
    drawSprite(frameIndex, x, y, scale = 1.0) {
        ...
        this.ctx.drawImage(this.spriteSheet.image, frame.x, frame.y, this.spriteSheet.frameWidth, this.spriteSheet.frameHeight, drawX, drawY, scaledSize, scaledSize);
    }
    /**
     ...
     */
    drawWithSquash(frameIndex, x, y, squashX, squashY) {
        if (!this.spriteSheet.loaded) {
            return;
        }
        const frame = this.spriteSheet.getFrame(frameIndex);
        ...
        this.ctx.drawImage(this.spriteSheet.image, frame.x, frame.y, this.spriteSheet.frameWidth, this.spriteSheet.frameHeight, drawX, drawY, scaledWidth, scaledHeight);
    }
}
/** Default visual size for sprites (matches emoji size) */
SpriteRenderer.DEFAULT_SIZE = 45;
